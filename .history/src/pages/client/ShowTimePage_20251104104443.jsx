...
import posterTraiTim from "../../assets/images/posters/traitimquequat.jpg";
...
const ShowtimePage = () => {
  ...
  const fakeMovie = {
    ...
    poster:
      "PosterTraiTim", // bạn có thể thay bằng poster thật
    duration: "125 phút",
    ...
    country: "Việt Nam",
    language: "Tiếng Việt",
    trailer: "https://www.youtube.com/embed/3tmd-ClpJxA", // có thể đổi sang trailer thật
  };
