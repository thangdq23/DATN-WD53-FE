...
const ShowtimePage = () => {
  ...
  const fakeMovie = [
    ...
    { id: 3, name: "Bẫy Tiền", description: "Một tay đầu tư trẻ tuổi bị cuốn vào trò chơi nguy hiểm giữa lòng tài chính ngầm, nơi không chỉ tiền bạc mà cả mạng sống đều bị đánh cược.", poster: posterBayTien, duration: "120 phút", director: "Charlie Nguyễn", actor: "Kiều Minh Tuấn, Jun Vũ, Hứa Vĩ Văn", genre: "Giật gân, Tâm lý", releaseDate: "21/11/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/7ZXuDXSkMGg", rating: 4.3 },
     { id: 4, name: "Phòng Trọ Ma Bấu", description: "Một nhóm bạn thuê trọ giá rẻ và phát hiện ra nơi đây ẩn chứa linh hồn oan khuất không thể siêu thoát. Tiếng cười xen lẫn tiếng thét trong câu chuyện kinh dị – hài hước này.", poster: posterPhongTro, duration: "120 phút", director: "Lê Bảo Trung", actor: "Hứa Minh Đạt, Nam Thư, Duy Khánh", genre: "Kinh dị, Hài hước", releaseDate: "28/11/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/jgZM5IhnzDA", rating: 4.2 },
