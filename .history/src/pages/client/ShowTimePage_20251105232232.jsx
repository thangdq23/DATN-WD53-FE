...
const ShowtimePage = () => {
  ...
  const fakeMovie = [
    ...
    { id: 3, name: "Bẫy Tiền", description: "Một tay đầu tư trẻ tuổi bị cuốn vào trò chơi nguy hiểm giữa lòng tài chính ngầm, nơi không chỉ tiền bạc mà cả mạng sống đều bị đánh cược.", poster: posterBayTien, duration: "120 phút", director: "Charlie Nguyễn", actor: "Kiều Minh Tuấn, Jun Vũ, Hứa Vĩ Văn", genre: "Giật gân, Tâm lý", releaseDate: "21/11/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/7ZXuDXSkMGg", rating: 4.3 },
     { id: 4, name: "Phòng Trọ Ma Bầu", description: "Một nhóm bạn thuê trọ giá rẻ và phát hiện ra nơi đây ẩn chứa linh hồn oan khuất không thể siêu thoát. Tiếng cười xen lẫn tiếng thét trong câu chuyện kinh dị – hài hước này.", poster: posterPhongTro, duration: "120 phút", director: "Lê Bảo Trung", actor: "Hứa Minh Đạt, Nam Thư, Duy Khánh", genre: "Kinh dị, Hài hước", releaseDate: "28/11/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/jgZM5IhnzDA", rating: 4.2 },
      { id: 5, name: "Quân Kỳ Nam", description: "Câu chuyện tình lãng mạn giữa cô họa sĩ trẻ và chàng quân nhân, gợi nhớ về những năm tháng tuổi trẻ đầy nhiệt huyết và hi sinh.", poster: posterQuanKy, duration: "120 phút", director: "Ngô Thanh Vân", actor: "Song Luân, Bảo Anh, Bình Minh", genre: "Lãng mạn, Tâm lý", releaseDate: "28/11/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/D_DvouZ61p8", rating: 4.6 },
       { id: 6, name: "Hoàng Tử Quỷ", description: "Một cậu bé bị nguyền rủa từ nhỏ và mang trong mình dòng máu quỷ vương. Khi lớn lên, cậu phải chọn giữa bóng tối và ánh sáng.", poster: posterHoangTu, duration: "120 phút", director: "Jordan Peele", actor: "Trần Nghĩa, Khả Ngân, Trấn Thành", genre: "Kinh dị, Giả tưởng", releaseDate: "05/12/2025", country: "Mỹ", language: "Tiếng Anh - Phụ đề Việt", trailer: "https://www.youtube.com/embed/Qzymh0WVyN8", rating: 4.1 },
        { id: 7, name: "Bà Đừng Buồn Con", description: "Một bộ phim đầy cảm xúc kể về tình mẫu tử, những hy sinh thầm lặng và hành trình chuộc lại lỗi lầm trong quá khứ.", poster: posterBaDung, duration: "120 phút", director: "Phan Gia Nhật Linh", actor: "Như Quỳnh, Trấn Thành, Lan Ngọc", genre: "Chính kịch, Tâm lý", releaseDate: "12/12/2025", country: "Việt Nam", language: "Tiếng Việt", trailer: "https://www.youtube.com/embed/za7_Zn-dXWw",rating: 4.8 },
         { id: 8, name: "Cô Hầu Gái", description: "Lấy bối cảnh thời Pháp thuộc, bộ phim xoay quanh một cô hầu gái vô tình phát hiện bí mật rùng rợn trong ngôi biệt thự cổ.", poster: posterCoHau, duration: "120 phút", director: "Derek Nguyễn", actor: "Nhung Kate, Jean-Michel Richaud, Kim Xuân", genre: "Kinh dị, Giật gân", releaseDate: "26/12/2025", country: "Việt Nam", language: "Tiếng Việt - Phụ đề Anh", trailer: "https://www.youtube.com/embed/OFPTgy3Ilr8", rating: 4.4 },
  ];
